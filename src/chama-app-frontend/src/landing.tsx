...
let detailsArray:Array<ActionType> = [
    {
        ...
        details:"Chama is a blockchain-powered investment group designed to bring trust, transparency and efficiency to how we pool and grow our finances"
    },
    {
        title:"decentralization",
        actionName:"see more",
        detailIcon:<FaTruckLoading className='text-blue-600'/>,
        details:"Built on decentralized technology, chama ensures that every contribution, withdrawal and transaction is secure, traceable and tamper-proof."
    },
    {
    ...
    return(
        <div className="w-full h-screen px-4 sm:px-8 md:px-12 relative select-none">
            ...
            <div className="w-full md:w-full h-4/5 relative mx-auto mt-24 flex flex-col gap-4">
                <h1 className='relative w-full h-auto text-left text-2xl font-bold text-blue-600 flex items-center justify-start gap-3'><FaUserFriends  className='text-blue-600 text-4xl'/><span className='text-blue-600' >Rotate</span><span className='text-pink-600' >Chain</span> </h1>
                <h1 className="w-full h-auto font-bold text-7xl mb-4">Invest In your Investment</h1>
                <div className='h-8 w-5/6 overflow-hidden'>
                ...
                <div className='w-full md:w-2/3 h-auto flex gap-2 justify-between flex-wrap' >
            ...
            <div className='w-full h-auto flex flex-col items-center gap-8 my-8 mx-auto' >
            ...
            <div className='w-full h-auto flex flex-col items-center gap-4'>
                ...
                <form onSubmit={subscribeHandler} className='w-3/4 md:w-1/2 h-12 mx-auto flex rounded-lg overflow-hidden'>
            ...
            <p className='text-xl text-blue-600 mt-12 font-bold text-center '>OGETA</p>
